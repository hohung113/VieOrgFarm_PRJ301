<%-- 
    ...
    Created on : Oct 19, 2023, 9:58:13 PM
    Author     : ASUS
--%>
    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link d-block" href="loaddata">
                Admin, <b>Back Home</b>
              </a>
            </li>
          </ul>
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tbody> 
                    ...
                    <c:choose>  
                        ...
                        <c:when test="${not empty requestScope.listMana}">
         
                    <c:forEach items="${requestScope.listMana}" var="p">
                        <tr>
                            <th scope="row"><input type="checkbox" /></th>
                            <td>${p.getCategoryID()}</td>
                            <td><a style="color: orange" href="update?pid=${p.getProductID()}">${p.getProductName()}</a> </td>
                            
<!--                             <td class="tm-product-name">${p.getProductName()} </td>-->
                            <td>${p.getPrice()}</td>
                            <td>${p.getQuantity()}</td>
                            ...
                            <td>
                                <a href="delete?pid=${p.productID}" class="tm-product-delete-link">
                        ...
                        <c:otherwise>
                        <td colspan="7"> Danh Sách Rỗng. Không Tồn Tại </td>
